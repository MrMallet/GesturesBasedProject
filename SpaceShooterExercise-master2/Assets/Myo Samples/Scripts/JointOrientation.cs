...
public class JointOrientation : MonoBehaviour
{
    ...
    public float speed;
    public Vector3 moveShip;
    void FixedUpdate() {


        moveShip = new Vector3(transform.localPosition.x, 0.0f , 0.0f);
      ...
      //  Vector3 eulerAngles = transform.localRotation.eulerAngles;
       ...
       // float moveHori = Thalmic.Myo.AccelerometerDataEventArgs

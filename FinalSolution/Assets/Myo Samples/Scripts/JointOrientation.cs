...
{
    private Vector3 referenceV;
    // private Vector2 referenceV;
    ...
    void Update ()
    {
        ...
        if (updateReference) {
            ...
            // if theres a roll either way we should call the movement
            ...
            referenceV = new Vector3(myo.transform.forward.x *20, 0 ,0); //myo.transform.forward.y*10

            //referenceV = new Vector2(myo.transform.forward.x *20,  myo.transform.forward.y*10 );

        }

        transform.position = new Vector3((myo.transform.forward.x *20)- referenceV.x, 0 , 0); //(myo.transform.forward.y *10) - referenceV.y
        //transform.position = Vector2((myo.transform.forward.x *20)- referenceV.x, (myo.transform.forward.y *10) - referenceV.y );
